...
const NAV_MAIN = [
  { to: '/admin', end: true, label: 'Dashboard', icon: <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/><rect x="3" y="14" width="7" height="7" rx="1"/><rect x="14" y="14" width="7" height="7" rx="1"/></svg> },
  { to: '/admin/comenzi', label: 'Comenzi', icon: <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><path d="M6 2 3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z"/><line x1="3" y1="6" x2="21" y2="6"/><path d="M16 10a4 4 0 0 1-8 0"/></svg> },
  { to: '/admin/produse', label: 'Produse', icon: <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><path d="m7.5 4.27 9 5.15"/><path d="M21 8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16Z"/><path d="m3.27 6.96 8.73 5.04 8.73-5.04"/><line x1="12" y1="22.08" x2="12" y2="12"/></svg> },
...
function NavGroup({ items }) {
  return items.map(({ to, end, label, icon }) => (
    <NavLink
      key={to}
      to={to}
      end={end}
...
export default function AdminLayout() {
  ...
  const sidebarContent = (
    <>
      <button className={styles.closeBtn} onClick={() => setOpen(false)} aria-label="Închide">
      ...
      <nav className={styles.nav}>
        ...
        <div className={styles.navSection}>Sistem</div>
        <NavGroup items={NAV_SYSTEM} />
      </nav>
