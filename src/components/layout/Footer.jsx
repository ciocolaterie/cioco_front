    ...
    <footer className={styles.footer}>
      ...
      <div className={styles.brand}>
        <div className="container">
          <div className={styles.brandInner}>
            <img
              src={store.storeLogo || DEFAULT_LOGO}
            ...
            />
            <div>
              <div className={styles.brandName}>{store.storeName || 'Ciocolaterie'}</div>
              <p className={styles.tagline}>Ciocolată artizanală, din atelier la tine.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className={`container ${styles.bottom}`}>
        <div className={styles.copy}>
          © {new Date().getFullYear()} {store.storeName || 'Ciocolaterie'}. Toate drepturile rezervate.
        </div>

        <div className={styles.socials}>
          {store.storePhone && (
            <a href={`https://wa.me/${store.storePhone.replace(/\D/g, '')}`} className={styles.socialBtn} aria-label="WhatsApp">
          ...
          {store.storeInstagram && (
            <a href={store.storeInstagram} target="_blank" rel="noopener noreferrer" className={styles.socialBtn} aria-label="Instagram">
          ...
          {store.storeFacebook && (
            <a href={store.storeFacebook} target="_blank" rel="noopener noreferrer" className={styles.socialBtn} aria-label="Facebook">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
